...
export const nmapHelpContent: Record<NmapFieldId, ToolHelpContent> = {
  target: {
    ...
    guidance: "Use a hostname, IP, or CIDR range. Keep it narrow while testing.",
  },
  ports: {
    title: "Ports",
    ...
    guidance: "Examples: 80,443,8080 or 1-1000. Leave empty for the default behavior.",
  },
  timing: {
    title: "Timing",
    summary: "Controls how fast and noisy the scan runs.",
    commandEffect: "Adds one timing template flag such as -T3 or -T4.",
    guidance: "T2 is quieter, T3 is balanced, and T4-T5 are faster but easier to notice.",
  },
  serviceDetection: {
    ...
    guidance: "Useful after finding open ports, especially when you need product versions.",
  },
  osDetection: {
    title: "OS detection",
    summary: "Attempts to fingerprint the target operating system.",
    commandEffect: "Adds -O unless aggressive mode is enabled.",
    guidance: "Works best when the target exposes enough network traits for fingerprinting.",
  },
  defaultScripts: {
    ...
    guidance: "Great for safe enumeration, but it is still more intrusive than a plain port scan.",
  },
  aggressive: {
    title: "Aggressive profile",
    summary: "Bundles service detection, OS detection, scripts, and traceroute.",
    commandEffect:
