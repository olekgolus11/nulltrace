const canonicalSeverities = ["info", "low", "medium", "high", "critical"] as const;

export type CanonicalFindingSeverity = (typeof canonicalSeverities)[number];

const severityLookup = canonicalSeverities.reduce<Record<string, CanonicalFindingSeverity>>(
...
const severityRank = canonicalSeverities.reduce<Record<CanonicalFindingSeverity, number>>(
